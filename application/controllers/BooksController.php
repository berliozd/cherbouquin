...
//        $newview->setScriptPath(APPLICATION_PATH . "/scripts");
//        $newview->var1 = "value var1";
//        $this->view->blockos = $newview->render("test.phtml");
//
//        $myView = new \Sb\View\ZendView\ZendView("test.phtml");
//        $myView->var2 = "value var 2";
//        $this->view->blockus = $myView->get();
    }
