...
class Zend_Service_Amazon_ResultSet implements SeekableIterator
{
    ...
    public function __construct(DOMDocument $dom)
    {
        ...
        Zend_Didier_Utils::RegisterNameSpace($this->_xpath);
        //$this->_xpath->registerNamespace('az', 'http://webservices.amazon.com/AWSECommerceService/2005-10-05');
        //$this->_xpath->registerNamespace('az', 'http://webservices.amazon.com/AWSECommerceService/2011-08-01'); // DIDIER FIX ZEND AMAZON
