...
class MailHelper {
    ...
    public static function validationAccountEmailBody($firstName, $token, $to) {
        $body = __("Bonjour", "s1b") . " " . $firstName
                ...
                . '<br/><br/>'
                . __("Nous vous conseillons de mettre à jour votre profil ainsi que vos paramètres puis d'ajouter vos amis afin de profiter au maximum du site",
                        "s1b")
                . '<br/>'
    ...
    public static function faceBookAccountCreationEmailBody($firstName) {
        $body = __("Bonjour", "s1b") . " " . $firstName
                ...
                . '<br/><br/>'
                . __("Nous vous conseillons de mettre à jour votre profil ainsi que vos paramètres puis d'ajoouter vos amis afin de profiter au maximum du site",
                        "s1b")
                . '<br/>'
                . __("Pour toute question ou remarque n'hésitez pas à nous envoyer un email à", "s1b") . " " . \Sb\Entity\Constants::SITENAME
                . " " . __("ou à utiliser le formulaire de contact du site", "s1b")
    ...
    public static function newPasswordBody($newPassword) {
        $body = __("Bonjour,", "s1b") . "<br \>" . __("Vous recevez cet e-mail suite à votre demande d'un nouveau mot de passe.",
                        "s1b")
    ...
    public static function newMessageArrivedBody($from) {
        $body = __("Bonjour", "s1b") . ','
                ...
                . '<br/><br/>' . __("L'équipe", "s1b") . " " . \Sb\Entity\Constants::SITENAME
                . '<br/><br/>'
                . '<h5>' . __("Si vous souhaitez ne plus recevoir par email les alertes modifiez les paramètres de votre profil dans",
                        "s1b")
                . " " . "<a href='" . \Sb\Helpers\HTTPHelper::Link(\Sb\Entity\Urls::USER_PROFILE_EDIT) . "'>" . __("Mes paramêtres",
                        "s1b") . "</a>" . '</h5>';
        return $body;
    }
    ...
    public static function recommandationBody(\Sb\Db\Model\Book $book) {
        $body = __("Découvrez", "s1b")
                ...
                . '<br/><br/>' . __("L'Ã©quipe", "s1b") . " " . \Sb\Entity\Constants::SITENAME
                . '<br/><br/>'
                . '<h5>' . __("Si vous souhaitez ne plus recevoir par email les alertes modifiez les paramètres de votre profil dans",
                        "s1b")
                . " " . "<a href='" . \Sb\Helpers\HTTPHelper::Link(\Sb\Entity\Urls::USER_PROFILE_EDIT) . "'>" . __("Mes paramètres",
                        "s1b") . "</a>" . '</h5>';
        return $body;
    }

    public static function friendRequestEmailBody($requestingUserUserName) {
        $body = sprintf(__("Bonjour,<br/><br/>Vous avez reçu une demande d'ami de %s<br/>Rendez-vous sur le site pour la valider <a href=\"%s\">%s</a>",
                        "s1b"), $requestingUserUserName, \Sb\Helpers\HTTPHelper::Link(""), \Sb\Entity\Constants::SITENAME);
        return $body;
    }
    ...
    public static function friendShipAcceptationEmailBody($acceptingUserUserName) {
        $body = __("Bonjour,", "s1b") . '<br/><br/>' . $acceptingUserUserName . " " . __("a accepté votre demande d'ami", "s1b")
                ...
                . " " . "<a href='" . \Sb\Helpers\HTTPHelper::Link("") . "'>" . \Sb\Entity\Constants::SITENAME . "</a>"
                . '<br/><br/>'
                . '<h5>' . __("Si vous souhaitez ne plus recevoir par email les alertes modifiez les paramètres de votre profil dans",
                        "s1b")
                . " " . "<a href='" . \Sb\Helpers\HTTPHelper::Link(\Sb\Entity\Urls::USER_PROFILE_SETTINGS) . "'>" . __("Mes paramètres",
                        "s1b") . "</a>" . '</h5>';
        return $body;
    }
